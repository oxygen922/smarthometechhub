...
export function SiteHeader({ site }: SiteHeaderProps) {
  ...
  return (
    <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${scrolled ? 'bg-brand-dark/95 backdrop-blur-md shadow-lg shadow-black/20' : 'bg-brand-dark'}`}>
